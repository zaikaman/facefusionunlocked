...
def load_frame_processor_module(frame_processor: str) -> Any:
    try:
        ...
        print(exception)  # Thêm dòng này để hiển thị thông báo lỗi của ModuleNotFoundError
        ...
        print(exception)  # Thêm dòng này để hiển thị thông báo lỗi của NotImplementedError
